...
window = Tk()
window.title("H A N G M A N")

word_list = ["INDIA","USA","RUSSIA","ENGLAND","GERMANY","ARGENTINA","ICELAND","CHILE","IRELAND","NORWAY","JAPAN","SRILANKA","SPAIN","NETHERLAND","MEXICO"]
		...
		if the_word_withSpaces.count(letter)>0:
			for c in range(len(txt)):
				...
				if lblWord.get()==the_word_withSpaces:
					messagebox.showinfo("Hangman", "You Guess It!")
					newGame()
		else:
			numberOfGuesses+=1
